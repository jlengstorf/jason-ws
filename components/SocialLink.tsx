...
const SocialLink: React.FC<any> = (data) => {
    const { platform, link } = data.data
    const platformCodename = platform.items[0]._system_.codename
    const platformName = platform.items[0]._system_.name
    ...
    return (
        <li className="bio-profile">
            <a
                ...
                data-sound-click="boop"
            >
                {platformCodename == "twitter" && (
                            <svg
